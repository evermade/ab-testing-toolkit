function abTestManager() {
    ...
    const validateOptions = (options) => {
        ...
        variants.forEach((variant) => {
            ...
            if (!onRun) {
                throw new Error('A variant must have an onRun function');
            }
        });
    };
    ...
    const run = (id) => {
        ...
        let selectedVariant;
        /**
         * Option 1: Allow user to specify a variant via URL parameter ?abtest=id&abvariant=slug
         */
